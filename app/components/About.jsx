...
export default class About extends React.Component {
  ...
  _getHomePurpose() {
    ...
    return (
      <div
        ...
        <strong><p style={styles.qheader}>What are we?</p></strong>
        <br/>
        ...
        <br/>
        <strong><p style={styles.qheader}>What kind of group are we and where did we originate from?</p></strong>
        <br/>
        <p style={styles.p}>We are a group, the University Innovation Fellows, that formed at the University of Delaware with the ambition to create a web app that allows students to pitch their own idea.</p>
        <br/>
        <strong><p style={styles.qheader}>What is this web app programmed in?</p></strong>
        <br/>
  ...
  render() {
    return (
      <div className={styles.about} style={{marginLeft: "50px"}}>
        <h1 className={styles.about__header}>ABOUT 20K PASSIONS.</h1>
